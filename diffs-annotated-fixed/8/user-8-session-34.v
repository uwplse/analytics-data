...
Fact denote_compose :
  ...
  compose_super (denote_circuit safe (f (add_fresh_pat w \206\1471)) \206\1470 (add_fresh_state w \206\1471)) (denote_circuit safe c \206\14701 \206\147).
...
-
(intros WT pf_merge1 pf_merge2).
replace (compose (gate g p1 f0) f) with gate g p1 (fun p2 => compose (f0 p2) h) by auto.
