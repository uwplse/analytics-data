...
Close Scope circ_scope.
Lemma dgc_aux :
  forall {n} (U \207\129 : Square n), U \226\138\151 I 1 \195\151 \207\129 \195\151 (U \226\138\151 I 1) \226\128\160 == U \195\151 \207\129 \195\151 (U) \226\128\160.
Proof.
(intros).
(rewrite kron_adjoint).
(rewrite (kron_1_r U)).
(rewrite id_adjoint_eq).
(rewrite (kron_1_r (U) \226\128\160)).
restore_dims.
reflexivity.
Qed.
...
Lemma ctrls_to_list_empty :
  forall W lb u, @ctrls_to_list W lb [] u = (O, [], Zero).
