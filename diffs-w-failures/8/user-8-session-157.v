...
Square (2 ^ \226\159\166 W \226\159\167) :=
  ...
  | db_gate g p c =>
      match g with
      | U u =>
          denote_u_db_circuit c \195\151 apply_unitary (\226\159\166 W \226\159\167) u (pat_to_list p)
      | _ => dummy_mat
      end
  | _ => dummy_mat
  end.
...
Definition denote_unitary_box {W} (c : Box W W) : 
  Square (2 ^ \226\159\166 W \226\159\167) := denote_u_db_box (hoas_to_db_box c).
...
Definition denote_init0 (n : nat) : Matrix (2 ^ (n + 1)) (2 ^ n) :=
  I (2 ^ n) \226\138\151 \226\136\1630\226\159\169.
Definition denote_init1 (n : nat) : Matrix (2 ^ (n + 1)) (2 ^ n) :=
  I (2 ^ n) \226\138\151 \226\136\1631\226\159\169.
...
Lemma isometry_box_to_db :
  forall W W' (c : Box W W'),
  Isometry_Box c -> Isometry_DB_Box (hoas_to_db_box c).
Proof.
(intros W W' c U).
...
Lemma denote_isometry_box_eq :
  ...
  Isometry_Box c ->
  denote_box false c \207\129 ==
  denote_isometry_box c \195\151 \207\129 \195\151 (denote_isometry_box c) \226\128\160.
Proof.
