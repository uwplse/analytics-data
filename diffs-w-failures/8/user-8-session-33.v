...
Fact denote_compose :
  ...
  forall w' (f : Pat w -> Circuit w') (\206\1470 \206\1471 \206\1471' \206\14701 : Ctx),
  ...
  denote_circuit safe (compose c f) \206\1470 \206\1471' =
  compose_super
    (denote_circuit safe (f (add_fresh_pat w \206\1471)) \206\1470 (add_fresh_state w \206\1471))
    (denote_circuit safe c \206\14701 \206\147).
Proof.
...
replace (compose (gate g p1 f) h) with gate g p1 (fun p2 => compose (f p2) h)
 by auto.
...
Theorem inSeq_correct :
  forall W1 W2 W3 (g : Box W2 W3) (f : Box W1 W2) (safe : bool),
  Typed_Box g ->
  Typed_Box f ->
...
Lemma HOAS_Equiv_inSeq :
  ...
  Typed_Box c1' ->
  Typed_Box c2 ->
  Typed_Box c2' -> c1 \226\137\161 c1' -> c2 \226\137\161 c2' -> c2 \194\183 c1 \226\137\161 c2' \194\183 c1'.
Proof.
