...
Qed.
Goal _
  forall m n (A B : Matrix m n), A == B -> I 1 \226\138\151 A \226\138\151 I 1 == I 1 \226\138\151 B \226\138\151 I 1.
Proof.
(intros).
(rewrite kron_1_l).
(rewrite kron_1_l).
...
Hint Rewrite
 @kron_1_l @kron_1_r' @Mmult_1_l @Mmult_1_r @Mscale_1_l @id_adjoint_eq
