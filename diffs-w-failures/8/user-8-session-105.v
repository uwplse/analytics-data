...
Definition unitary_at1 n (U : Unitary Qubit) (i : Var) 
  (pf : i < n) : Box (n \226\168\130 Qubit) (n \226\168\130 Qubit).
Proof.
gen n U.
...
Lemma unitary_at1_WT :
  forall n (U : Unitary Qubit) i (pf : i < n),
...
exact
 (box_ q
  \226\135\146 (let_ (q0, (q1, qs))\226\134\144 q; let_ (q0, q1)\226\134\144 CNOT $ (q0, q1); (q0, (q1, qs)))).
*
(destruct n as [| [| n']]; try omega).
refine
 (box_ q
...
Qed.
Lemma CNOT_at_i0_SS :
  forall n j (pfj : 0 < S (S j)) (pfj' : 0 < S j) 
    (pfn : S (S j) < S (S n)) (pfn' : S j < S n),
  CNOT_at_i0 (S (S n)) (S (S j)) pfj pfn =
  box_ q
  \226\135\146 (let_ (q0, (q1, qs))\226\134\144 q;
     let_ (q0, qs)\226\134\144 CNOT_at_i0 (S n) (S j) pfj' pfn' $ (q0, qs);
     (q0, (q1, qs))).
Proof.
(intros).
(simpl).
...
exact
 (box_ q
  \226\135\146 (let_ (q0, (q1, qs))\226\134\144 q; let_ (q1, q0)\226\134\144 CNOT $ (q1, q0); (q0, (q1, qs)))).
*
(destruct n as [| [| n']]; try omega).
refine
 (box_ q
...
Qed.
Lemma CNOT_at_j0_SS :
  forall n i (pfi : 0 < S (S i)) (pfi' : 0 < S i) 
    (pfn : S (S i) < S (S n)) (pfn' : S i < S n),
  CNOT_at_j0 (S (S n)) (S (S i)) pfi pfn =
  box_ q
  \226\135\146 (let_ (q0, (q1, qs))\226\134\144 q;
     let_ (q0, qs)\226\134\144 CNOT_at_j0 (S n) (S i) pfi' pfn' $ (q0, qs);
     (q0, (q1, qs))).
Proof.
(intros).
(simpl).
...
*
refine
 (box_ q \226\135\146 (let_ (q0, qs)\226\134\144 q; let_ qs \226\134\144 IHn i' j' _ _ _ $ qs; (q0, qs))).
+
...
omega.
Qed.
Definition TOF_at_ij01 (n k : nat) (pf_j : 1 < k) 
  (pf_n : k < n) : Box (n \226\168\130 Qubit) (n \226\168\130 Qubit).
gen n.
...
(refine
  (box_ q
   \226\135\146 (let_ (q0, (q1, (q2, qs)))\226\134\144 q;
      let_ (q0, (q1, qs))\226\134\144 IHk _ (S (S n)) _ $ (q0, (q1, qs));
      (q0, (q1, (q2, qs))))); auto with arith).
Defined.
Lemma TOF_at_ij01_WT :
  forall n k pf_j pf_n, Typed_Box (TOF_at_ij01 n k pf_j pf_n).
Proof.
(intros n k).
gen n.
...
(set
  (pf_n' :=
   gt_le_S (S (S k)) (S (S n)) (gt_S_le (S (S (S k))) (S (S n)) pf_n))).
specialize (IHk _ pf_j' pf_n').
type_check.
Qed.
Definition TOF_at_ik01 (n j : nat) (pf_j : 1 < j) 
  (pf_n : j < n) : Box (n \226\168\130 Qubit) (n \226\168\130 Qubit).
gen n.
...
(refine
  (box_ q
   \226\135\146 (let_ (q0, (q1, (q2, qs)))\226\134\144 q;
      let_ (q0, (q1, qs))\226\134\144 IHj _ (S (S n)) _ $ (q0, (q1, qs));
      (q0, (q1, (q2, qs))))); auto with arith).
Defined.
Lemma TOF_at_ik01_WT :
  forall n j pf_j pf_n, Typed_Box (TOF_at_ik01 n j pf_j pf_n).
Proof.
(intros n j).
gen n.
...
(set
  (pf_n' :=
   gt_le_S (S (S j)) (S (S n)) (gt_S_le (S (S (S j))) (S (S n)) pf_n))).
specialize (IHj _ pf_j' pf_n').
type_check.
Qed.
Definition TOF_at_ki01 (n j : nat) (pf_j : 1 < j) 
  (pf_n : j < n) : Box (n \226\168\130 Qubit) (n \226\168\130 Qubit).
gen n.
(induction j as [| [| [| j]]]; intros; try omega).
-
...
(refine
  (box_ q
   \226\135\146 (let_ (q0, (q1, (q2, qs)))\226\134\144 q;
      ...
      (q0, (q1, (q2, qs))))); auto with arith).
Defined.
Lemma TOF_at_ki01_WT :
  forall n j pf_j pf_n, Typed_Box (TOF_at_ki01 n j pf_j pf_n).
Proof.
(intros n j).
gen n.
(induction j as [| [| [| j]]]; intros; destruct n as [| [| [| n]]]; try omega).
...
type_check.
Qed.
Definition TOF_at_i0 (n j k : nat) (pf_ij : 0 < j) 
  (pf_ik : 0 < k) (pf_jk : j <> k) (pf_jn : j < n) 
  (pf_kn : k < n) : Box (n \226\168\130 Qubit) (n \226\168\130 Qubit).
gen n k.
(induction j as [| [| j]]; intros; try omega).
-
...
type_check.
Qed.
Definition TOF_at_k0 (n i j : nat) (pf_ij : i < j) 
  (pf_ik : 0 < i) (pf_jk : 0 < j) (pf_in : i < n) 
  (pf_jn : j < n) : Box (n \226\168\130 Qubit) (n \226\168\130 Qubit).
gen n j.
...
Definition Toffoli_at' (n : nat) (i j k : Var) (pf_i : i < n) 
  (pf_j : j < n) (pf_k : k < n) (pf_i_j : i <> j) 
  (pf_i_k : i <> k) (pf_j_k : j <> k) : Box (n \226\168\130 Qubit) (n \226\168\130 Qubit).
gen i j k.
...
(refine
  (box_ q
   \226\135\146 (let_ (q0, qs)\226\134\144 q; let_ qs \226\134\144 IHn i _ j _ _ k _ _ _ $ qs; (q0, qs)));
  auto with arith).
Defined.
Lemma Toffoli_at'_WT :
  forall n (i j k : Var) (pf_i : i < n) (pf_j : j < n) 
    (pf_k : k < n) (pf_i_j : i <> j) (pf_i_k : i <> k) 
    (pf_j_k : j <> k),
...
Lemma strip_one_l_in_WT :
  forall W W' (c : Box (One \226\138\151 W) W'),
...
Lemma strip_one_l_in_eq :
  forall W W' (c : Box (One \226\138\151 W) W')
    (\207\129 : Matrix (2 ^ \226\159\166 W \226\159\167)%nat (2 ^ \226\159\166 W' \226\159\167)%nat),
...
Lemma strip_one_l_out_WT :
  forall W W' (c : Box W (One \226\138\151 W')),
...
Lemma strip_one_r_in_WT :
  forall W W' (c : Box (W \226\138\151 One) W'),
...
Lemma strip_one_r_out_WT :
  forall W W' (c : Box W (W' \226\138\151 One)),
...
(rewrite add_fresh_split).
Admitted.
Fixpoint assert_at (b : bool) (n i : nat) {struct i} :
Box (S n \226\168\130 Qubit) (n \226\168\130 Qubit) :=
  match i with
...
(apply IHi).
Qed.
Fixpoint init_at (b : bool) (n i : nat) {struct i} :
Box (n \226\168\130 Qubit) (S n \226\168\130 Qubit) :=
  match i with
...
forall n t, Box ((n + t) \226\168\130 Qubit) ((n + t) \226\168\130 Qubit) -> Set :=
  ...
  | sym_gate :
      forall n t k c g,
      gate_acts_on k g ->
      source_symmetric n t c -> source_symmetric n t (g \194\183 c \194\183 g)
  | target_gate_l :
      forall n t k c g,
      gate_acts_on k g ->
...
Lemma gate_acts_on_WT :
  forall m (g : Box (m \226\168\130 Qubit) (m \226\168\130 Qubit)) k,
  gate_acts_on k g -> Typed_Box g.
Proof.
(intros m g k pf_g).
(destruct pf_g; type_check).
Qed.
Lemma source_symmetric_WT :
  forall n t c, source_symmetric n t c -> Typed_Box c.
Proof.
(intros n t c H).
...
Fact gate_acts_on_noop_at :
  forall m g k i,
  @gate_acts_on (S m) k g -> i <> k -> i < S m -> noop_on m i g.
Proof.
...
Fact assert_at_spec_safe :
  ...
  .+ I (2 ^ i) \226\138\151 \226\159\1681\226\136\163 \226\138\151 I (2 ^ (n - i)) \195\151 \207\129
     \195\151 (I (2 ^ i) \226\138\151 \226\136\1631\226\159\169 \226\138\151 I (2 ^ (n - i))).
Admitted.
...
Fact valid_inSeq :
  ...
  Typed_Box c1 ->
  Typed_Box c2 ->
  valid_ancillae_box' c1 ->
  valid_ancillae_box' c2 -> valid_ancillae_box' (c2 \194\183 c1).
Proof.
...
Lemma denote_box_id_circ :
  forall b w \207\129, denote_box b (id_circ : Box w w) \207\129 == \207\129.
Proof.
(intros b w \207\129).
(simpl).
...
Fact init_at_noop :
  forall b m i j,
  valid_ancillae_box'
    (assert_at b (S m) i \194\183 init_at b (S m) j \194\183 init_at b m i).
Proof.
Admitted.
...
Admitted.
Fact ancilla_free_Toffoli_at :
  forall n a b c, ancilla_free_box (Toffoli_at n a b c).
Admitted.
...
replace ((symmetric_reverse n t c pf_sym \194\183 g) \194\183 g \194\183 c) with
 symmetric_reverse n t c pf_sym \194\183 (g \194\183 g) \194\183 c
...
(apply HOAS_Equiv_inSeq'; [  | reflexivity ]).
(rewrite HOAS_Equiv_inSeq';
  [ rewrite inSeq_id_l; reflexivity | reflexivity |  ]).
(apply IHpf_sym).
-
