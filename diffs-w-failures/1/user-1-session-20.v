...
Inductive handle :=
    Handle : forall n : nat, _.
Axiom (block : Type).
Theorem exists_manipulation (F : pred nat block) (o : list handle)
  (s : nat -> option unit) a (d : mem nat block) :
  (F * (exists! v h o', [o = Handle h :: o'] * [s h = None] * a |-> v))%pred
    d -> True.
Proof.
(intros).
