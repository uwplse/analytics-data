...
Class Default A :=
    default_val : A.
Instance def_f  A B {def : Default B}: (Default (A -> B)) :=
 (fun _ => default_val).
...
Inductive t (A : Type) : Type :=
  | empty : _
  | cons : forall (i : I) (x : A) (xs : t A), _.
Definition index_eq (i1 i2 : I) : bool := Nat.eqb i1 i2.
Theorem index_eq_prop : forall i1 i2, index_eq i1 i2 = true <-> i1 = i2.
Proof.
...
Notation "[ i1 |-> v1 ]  :: vm" := (varmap.cons i1 v1 vm)
  (at level 20, vm  at level 80, only printing) : varmap_scope.
