...
Definition iRes_singleton {\206\163} {A} {i : inG \206\163 A} (\206\179 : gname) 
  (a : A) : iResUR \206\163 :=
  ofe_fun_singleton (inG_id i) {[\206\179 := cmra_transport inG_prf a]}.
...
Time Proof.
Time by intros n a a' Ha; apply ofe_fun_singleton_ne; rewrite Ha.
Time Qed.
Time
...
Time Proof.
Time
by rewrite /iRes_singleton ofe_fun_op_singleton op_singleton
 cmra_transport_op.
Time Qed.
...
Time rewrite {+1}/iRes_singleton ofe_fun_lookup_singleton lookup_singleton.
...
Time exists (ofe_fun_insert (inG_id _) (delete \206\179 (r (inG_id Hin))) r).
Time (intros i').
Time rewrite ofe_fun_lookup_op.
Time (destruct (decide (i' = inG_id _)) as [->| ?]).
Time +
Time rewrite ofe_fun_lookup_insert ofe_fun_lookup_singleton.
Time (intros \206\179').
...
Time by rewrite ofe_fun_lookup_singleton_ne // left_id.
Time -
...
(<ssreflect_plugin::ssrtclseq@0>
  ...
  first  eapply alloc_updateP_strong', cmra_transport_valid, Ha; naive_solver).
Time -
Time
...
Time
(<ssreflect_plugin::ssrtclseq@0>
 eapply bupd_ownM_updateP, ofe_fun_singleton_updateP ; first  by
...
Time (apply bupd_ownM_update, ofe_fun_singleton_update_empty).
Time
(<ssreflect_plugin::ssrtclseq@0>
