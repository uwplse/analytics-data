...
Context `{!exmachG \206\163} `{lockG \206\163} `{!@cfgG DB.Op DB.l \206\163}
 `{!inG \206\163 (authR (optionUR (exclR (listC natC))))}.
Time Import ExMach.
Time
...
Context `{!exmachG \206\163} `{lockG \206\163} `{!@cfgG AtomicPair.Op AtomicPair.l \206\163}
 `{!inG \206\163 (authR (optionUR (exclR (prodC natC natC))))}
 `{!inG \206\163 (authR (optionUR (exclR natC)))}.
Time Import ExMach.
Time
...
Instance subG_helper\206\163 :
 (subG helper\206\163 \206\163 \226\134\146 inG \206\163 (authR (optionUR (exclR (listC natC))))).
Time Proof.
Time solve_inG.
Time Qed.
Time
...
Time
Instance subG_helper\206\163 :
 (subG helper\206\163 \206\163 \226\134\146 inG \206\163 (authR (optionUR (exclR natC)))).
Time Proof.
Time solve_inG.
Time Qed.
Time
Instance subG_helper\206\163' :
 (subG helper\206\163 \206\163 \226\134\146 inG \206\163 (authR (optionUR (exclR (prodC natC natC))))).
Time Proof.
Time solve_inG.
Time Qed.
Time
...
Time Qed.
Time #[global]
Instance inG_inst1 : (inG \206\163 (authR (optionUR (exclR (prodC natC natC))))).
Time Proof.
Time (apply _).
Time Qed.
Time #[global]Instance inG_inst2 : (inG \206\163 (authR (optionUR (exclR natC)))).
Time Proof.
Time (apply _).
Time Qed.
