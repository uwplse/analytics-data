...
Time Canonical Structure gsetC := discreteC (gset K).
...
Time Canonical Structure gset_disjC := leibnizC (gset_disj K).
Time
...
Time Qed.
Time End gset_disj.
Time Arguments gset_disjC _ {_} {_}.
