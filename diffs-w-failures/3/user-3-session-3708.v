...
Time From iris.bi Require Import derived_laws_sbi plainly.
...
Time (induction 1; simpl; apply _).
Time Qed.
Time Section plainly.
Time Context `{!BiPlainly PROP}.
Time
Lemma big_sepL_plainly `{!BiAffine PROP} \206\166 l :
  \226\150\160 ([\226\136\151 list] k\226\134\166x \226\136\136 l, \206\166 k x) \226\138\163\226\138\162 ([\226\136\151 list] k\226\134\166x \226\136\136 l, \226\150\160 \206\166 k x).
Time Proof.
Time (apply (big_opL_commute _)).
Time Qed.
Time #[global]
Instance big_sepL_nil_plain  `{!BiAffine PROP} \206\166:
 (Plain ([\226\136\151 list] k\226\134\166x \226\136\136 [], \206\166 k x)).
Time Proof.
Time (simpl; apply _).
Time Qed.
Time #[global]
Instance big_sepL_plain  `{!BiAffine PROP} \206\166 l:
 ((\226\136\128 k x, Plain (\206\166 k x)) \226\134\146 Plain ([\226\136\151 list] k\226\134\166x \226\136\136 l, \206\166 k x)).
Time Proof.
Time revert \206\166.
Time
(<ssreflect_plugin::ssrtclintros@0> induction l as [| x l IH] =>\206\166 ? /=;
...
Time Qed.
Time
Lemma big_andL_plainly \206\166 l :
...
Time Qed.
Time #[global]
Instance big_andL_nil_plain  \206\166: (Plain ([\226\136\167 list] k\226\134\166x \226\136\136 [], \206\166 k x)).
Time Proof.
Time (simpl; apply _).
Time Qed.
Time #[global]
Instance big_andL_plain  \206\166 l:
 ((\226\136\128 k x, Plain (\206\166 k x)) \226\134\146 Plain ([\226\136\167 list] k\226\134\166x \226\136\136 l, \206\166 k x)).
Time Proof.
Time revert \206\166.
Time
(<ssreflect_plugin::ssrtclintros@0> induction l as [| x l IH] =>\206\166 ? /=;
...
Time Qed.
Time
Lemma big_orL_plainly `{!BiPlainlyExist PROP} \206\166 l :
...
Time Qed.
Time #[global]
Instance big_orL_nil_plain  \206\166: (Plain ([\226\136\168 list] k\226\134\166x \226\136\136 [], \206\166 k x)).
Time Proof.
Time (simpl; apply _).
Time Qed.
Time #[global]
Instance big_orL_plain  \206\166 l:
...
Time Context `{!BiPlainly PROP}.
Time
Lemma big_sepL2_plainly `{!BiAffine PROP} \206\166 l1 l2 :
...
Time Qed.
Time #[global]
Instance big_sepL2_nil_plain  `{!BiAffine PROP} \206\166:
 (Plain ([\226\136\151 list] k\226\134\166y1;y2 \226\136\136 [];[], \206\166 k y1 y2)).
Time Proof.
Time (simpl; apply _).
Time Qed.
Time #[global]
Instance big_sepL2_plain  `{!BiAffine PROP} \206\166 l1 l2:
...
Time Context `{!BiPlainly PROP}.
Time
Lemma big_sepM_plainly `{BiAffine PROP} \206\166 m :
...
Time Qed.
Time #[global]
Instance big_sepM_empty_plain  `{BiAffine PROP} \206\166:
 (Plain ([\226\136\151 map] k\226\134\166x \226\136\136 \226\136\133, \206\166 k x)).
Time Proof.
Time rewrite /big_opM map_to_list_empty.
Time (apply _).
Time Qed.
Time #[global]
Instance big_sepM_plain  `{BiAffine PROP} \206\166 m:
...
Time Context `{!BiPlainly PROP}.
Time
Lemma big_sepM2_plainly `{BiAffine PROP} \206\166 m1 m2 :
...
Time Qed.
Time #[global]
Instance big_sepM2_empty_plain  `{BiAffine PROP} \206\166:
 (Plain ([\226\136\151 map] k\226\134\166x1;x2 \226\136\136 \226\136\133;\226\136\133, \206\166 k x1 x2)).
Time Proof.
Time rewrite /big_sepM2 map_zip_with_empty.
Time (apply _).
Time Qed.
Time #[global]
Instance big_sepM2_plain  `{BiAffine PROP} \206\166 m1 m2:
...
Time Context `{!BiPlainly PROP}.
Time
Lemma big_sepS_plainly `{BiAffine PROP} \206\166 X :
  \226\150\160 ([\226\136\151 set] y \226\136\136 X, \206\166 y) \226\138\163\226\138\162 ([\226\136\151 set] y \226\136\136 X, \226\150\160 \206\166 y).
Time Proof.
Time (apply (big_opS_commute _)).
Time Qed.
Time #[global]
Instance big_sepS_empty_plain  `{BiAffine PROP} \206\166:
 (Plain ([\226\136\151 set] x \226\136\136 \226\136\133, \206\166 x)).
Time Proof.
Time rewrite /big_opS elements_empty.
Time (apply _).
Time Qed.
Time #[global]
Instance big_sepS_plain  `{BiAffine PROP} \206\166 X:
 ((\226\136\128 x, Plain (\206\166 x)) \226\134\146 Plain ([\226\136\151 set] x \226\136\136 X, \206\166 x)).
Time Proof.
Time rewrite /big_opS.
Time (apply _).
Time Qed.
...
Time Context `{!BiPlainly PROP}.
Time
Lemma big_sepMS_plainly `{BiAffine PROP} \206\166 X :
  \226\150\160 ([\226\136\151 mset] y \226\136\136 X, \206\166 y) \226\138\163\226\138\162 ([\226\136\151 mset] y \226\136\136 X, \226\150\160 \206\166 y).
Time Proof.
Time (apply (big_opMS_commute _)).
Time Qed.
Time #[global]
Instance big_sepMS_empty_plain  `{BiAffine PROP} \206\166:
 (Plain ([\226\136\151 mset] x \226\136\136 \226\136\133, \206\166 x)).
Time Proof.
Time rewrite /big_opMS gmultiset_elements_empty.
Time (apply _).
Time Qed.
Time #[global]
Instance big_sepMS_plain  `{BiAffine PROP} \206\166 X:
 ((\226\136\128 x, Plain (\206\166 x)) \226\134\146 Plain ([\226\136\151 mset] x \226\136\136 X, \206\166 x)).
Time Proof.
Time rewrite /big_opMS.
Time (apply _).
Time Qed.
