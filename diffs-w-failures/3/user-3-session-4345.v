...
Time
Lemma bool_decide_true (P : Prop) `{Decision P} : P \226\134\146 bool_decide P = true.
Time Proof.
Time (case_bool_decide; tauto).
Time Qed.
Time
Lemma bool_decide_false (P : Prop) `{Decision P} :
  \194\172 P \226\134\146 bool_decide P = false.
Time Proof.
Time (case_bool_decide; tauto).
Time Qed.
Time
