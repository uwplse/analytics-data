...
Theorem seq_star_invariant A (r : relation A A unit) 
  P :
...
Lemma seq_star_inv_rep_n A T (p : relation A A T) 
  a1 a2 t : seq_star p a1 a2 t -> exists n, seq_rep_n n p a1 a2 t.
Proof.
(induction 1).
-
(exists O; firstorder).
...
rew Htrans.
Qed.
Lemma any_seq_star_any A T : _ <- @any A A T; seq_star (@any A A T) ---> any.
Proof.
