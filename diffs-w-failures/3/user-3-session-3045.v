...
Time Import TwoDisk.
Time Canonical Structure diskIdC := leibnizC diskId.
Time
...
Time (inversion Hstep; subst).
Time inv_step.
Time Class lockG \206\163 := LockG {lock_tokG :> inG \206\163 (exclR unitC)}.
Time Definition lock\206\163 : gFunctors := #[ GFunctor (exclR unitC)].
