...
Class leased_heapPreG (L V : Type) (\206\163 : gFunctors) `{Countable L} :={
 ...
 leased_heap_exclPreG :> inG \206\163 (authR (optionUR (exclR (leibnizC V))))}.
Time
Definition leased_heap\206\163 (L V : Type) `{Countable L} : gFunctors :=
  #[ gen_heap\206\163 L V; GFunctor (authR (optionUR (exclR (leibnizC V))))].
Time
...
Definition lease (l : L) (v : V) :=
  (\226\136\131 \206\179 : gname,
     ...
     \226\136\151 own \206\179 (\226\151\175 Excl' (v : leibnizC V)))%I.
Time
Definition master (l : L) (v : V) :=
  (\226\136\131 \206\179 : gname,
     meta l (current_gen (leased_heap_gen hG)) \206\179
     \226\136\151 meta_token l (\226\134\145next_gen (leased_heap_gen hG))
       \226\136\151 own \206\179 (\226\151\143 Excl' (v : leibnizC V)))%I.
...
Time
iMod (own_alloc (\226\151\143 Excl' (v : leibnizC V) \226\139\133 \226\151\175 Excl' (v : leibnizC V))) as (
 \206\179' ) "[H1 H2]".
Time {
...
Time iIntros "H".
Time
iMod (own_alloc (\226\151\143 Excl' (v : leibnizC V) \226\139\133 \226\151\175 Excl' (v : leibnizC V))) as ( \206\179
 ) "[H1 H2]".
Time {
Time (apply auth_both_valid; split; eauto).
Time econstructor.
...
Time
iMod
 (own_update_2 _ _ _ (\226\151\143 Excl' (v' : leibnizC V) \226\139\133 \226\151\175 Excl' (v' : leibnizC V))
