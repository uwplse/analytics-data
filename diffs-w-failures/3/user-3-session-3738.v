...
Definition wp_pre {OpT} `{\206\155 : Layer OpT} `{irisG OpT \206\155 \206\163} 
  (s : stuckness)
  (wp : ofe_funC (\206\187 T, coPset -c> proc OpT T -c> (T -c> iProp \206\163) -c> iProp \206\163))
  : ofe_funC (\206\187 T, coPset -c> proc OpT T -c> (T -c> iProp \206\163) -c> iProp \206\163) :=
