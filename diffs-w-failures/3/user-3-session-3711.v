...
Time Qed.
Time
Lemma fupd_big_sepL {A} E (\206\166 : nat \226\134\146 A \226\134\146 PROP) (l : list A) :
...
Time Proof.
Time (apply (big_opL_forall (\206\187 P Q, P ={E}=\226\136\151 Q)); auto using fupd_intro).
Time (intros P1 P2 HP Q1 Q2 HQ).
Time by rewrite HP HQ -fupd_sep.
Time Qed.
Time
Lemma fupd_big_sepM `{Countable K} {A} E (\206\166 : K \226\134\146 A \226\134\146 PROP) 
  (m : gmap K A) :
  ([\226\136\151 map] k\226\134\166x \226\136\136 m, |={E}=> \206\166 k x) ={E}=\226\136\151 [\226\136\151 map] k\226\134\166x \226\136\136 m, \206\166 k x.
Time Proof.
Time (apply (big_opM_forall (\206\187 P Q, P ={E}=\226\136\151 Q)); auto using fupd_intro).
Time (intros P1 P2 HP Q1 Q2 HQ).
Time by rewrite HP HQ -fupd_sep.
Time Qed.
Time
Lemma fupd_big_sepS `{Countable A} E (\206\166 : A \226\134\146 PROP) 
  X : ([\226\136\151 set] x \226\136\136 X, |={E}=> \206\166 x) ={E}=\226\136\151 [\226\136\151 set] x \226\136\136 X, \206\166 x.
Time Proof.
Time (apply (big_opS_forall (\206\187 P Q, P ={E}=\226\136\151 Q)); auto using fupd_intro).
Time (intros P1 P2 HP Q1 Q2 HQ).
Time by rewrite HP HQ -fupd_sep.
Time Qed.
Time
