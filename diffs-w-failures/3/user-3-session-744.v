...
Time
Tactic Notation
 "iPoseProofCoreLem" constr(lem) "as" constr(Hnew) "before_tc" tactic(tac) :=
...
Time
Tactic Notation
 "iPoseProofCore" open_constr(lem) "as" constr(p) constr(lazy_tc) tactic(tac)
 :=
 (iStartProof;
   (let Htmp := iFresh in
    ...
    lazymatch type of t with
    | ident =>
        iPoseProofCoreHyp t as Htmp; spec_tac ltac:(()); [ .. | tac Htmp ]
    | _ =>
        lazymatch eval compute in lazy_tc with
        | true => iPoseProofCoreLem t as Htmp before_tc
        spec_tac ltac:(()); [ .. | tac Htmp ]
        | false => iPoseProofCoreLem t as Htmp before_tc
        spec_tac ltac:(()); [ .. | tac Htmp ]
        end
    end)).
Time #[local]
...
Time
Tactic Notation "iApply" open_constr(lem) := iPoseProofCore lem as false true
 fun H => iApplyHyp H.
Time
...
Time
Tactic Notation
 "iRevertIntros" "(" ident(x1) ")" constr(Hs) "with" tactic(tac) :=
 iRevertIntros Hs with iRevert ( x1 ); tac; iIntros ( x1 ).
Time
Tactic Notation
 "iRevertIntros" "(" ident(x1) ident(x2) ")" constr(Hs) "with" tactic(tac) :=
 iRevertIntros Hs with iRevert ( x1 x2 ); tac; iIntros ( x1 x2 ).
Time
Tactic Notation
 "iRevertIntros" "(" ident(x1) ident(x2) ident(x3) 
 ")" constr(Hs) "with" tactic(tac) := iRevertIntros Hs with
...
Tactic Notation
 "iRevertIntros" "(" ident(x1) ident(x2) ident(x3) ident(x4) ident(x5)
 ident(x6) ")" constr(Hs) "with" tactic(tac) := iRevertIntros Hs with
 iRevert ( x1 x2 x3 x4 x5 x6 ); tac; iIntros ( x1 x2 x3 x4 x5 x6 ).
Time
Tactic Notation
 "iRevertIntros" "(" ident(x1) ident(x2) ident(x3) ident(x4) ident(x5)
 ident(x6) ident(x7) ")" constr(Hs) "with" tactic(tac) := iRevertIntros Hs
 with iRevert ( x1 x2 x3 x4 x5 x6 x7 ); tac; iIntros ( x1 x2 x3 x4 x5 x6 x7 ).
Time
Tactic Notation
 "iRevertIntros" "(" ident(x1) ident(x2) ident(x3) ident(x4) ident(x5)
 ident(x6) ident(x7) ident(x8) ")" constr(Hs) "with" tactic(tac) :=
 iRevertIntros Hs with
 iRevert ( x1 x2 x3 x4 x5 x6 x7 x8 ); tac; iIntros ( x1 x2 x3 x4 x5 x6 x7 x8
  ).
Time
Tactic Notation "iRevertIntros" "with" tactic(tac) := iRevertIntros "" with
 tac.
Time
...
Time
Tactic Notation
 "iRevertIntros" "(" ident(x1) ident(x2) ")" "with" tactic(tac) :=
 iRevertIntros ( x1 x2 ) "" with tac.
Time
Tactic Notation
 "iRevertIntros" "(" ident(x1) ident(x2) ident(x3) ")" "with" tactic(tac) :=
 iRevertIntros ( x1 x2 x3 ) "" with tac.
Time
Tactic Notation
 "iRevertIntros" "(" ident(x1) ident(x2) ident(x3) ident(x4) 
 ")" "with" tactic(tac) := iRevertIntros ( x1 x2 x3 x4 ) "" with tac.
Time
Tactic Notation
 "iRevertIntros" "(" ident(x1) ident(x2) ident(x3) ident(x4) ident(x5) 
 ")" "with" tactic(tac) := iRevertIntros ( x1 x2 x3 x4 x5 ) "" with tac.
Time
Tactic Notation
 "iRevertIntros" "(" ident(x1) ident(x2) ident(x3) ident(x4) ident(x5)
 ident(x6) ")" "with" tactic(tac) := iRevertIntros ( x1 x2 x3 x4 x5 x6 ) ""
 with tac.
Time
Tactic Notation
 "iRevertIntros" "(" ident(x1) ident(x2) ident(x3) ident(x4) ident(x5)
 ident(x6) ident(x7) ")" "with" tactic(tac) := iRevertIntros ( x1 x2 x3 x4 x5
 x6 x7 ) "" with tac.
Time
Tactic Notation
 "iRevertIntros" "(" ident(x1) ident(x2) ident(x3) ident(x4) ident(x5)
 ident(x6) ident(x7) ident(x8) ")" "with" tactic(tac) := iRevertIntros ( x1
       ...
       | Some ?H =>
           ...
           | Some (true, ?P) =>
               tryif (let dummy := constr:(_ : CopyDestruct P) in
                      idtac) then iPoseProofCore lem as p false tac else
...
Tactic Notation
 ...
 ")" constr(pat) := iPoseProofCore lem as pat false
 fun H => iDestructHyp H as ( x1 ) pat.
Time
Tactic Notation
 "iPoseProof" open_constr(lem) "as" "(" simple_intropattern(x1)
 simple_intropattern(x2) ")" constr(pat) := iPoseProofCore lem as pat false
 fun H => iDestructHyp H as ( x1 x2 ) pat.
Time
Tactic Notation
 "iPoseProof" open_constr(lem) "as" "(" simple_intropattern(x1)
...
Tactic Notation
 "iPoseProof" open_constr(lem) "as" "(" simple_intropattern(x1)
 simple_intropattern(x2) simple_intropattern(x3) simple_intropattern(x4)
 simple_intropattern(x5) ")" constr(pat) := iPoseProofCore lem as pat false
 fun H => iDestructHyp H as ( x1 x2 x3 x4 x5 ) pat.
Time
Tactic Notation
 "iPoseProof" open_constr(lem) "as" "(" simple_intropattern(x1)
 simple_intropattern(x2) simple_intropattern(x3) simple_intropattern(x4)
 simple_intropattern(x5) simple_intropattern(x6) ")" constr(pat) :=
 iPoseProofCore lem as pat false
 fun H => iDestructHyp H as ( x1 x2 x3 x4 x5 x6 ) pat.
Time
Tactic Notation
 "iPoseProof" open_constr(lem) "as" "(" simple_intropattern(x1)
...
Tactic Notation
 ...
 simple_intropattern(x2) simple_intropattern(x3) simple_intropattern(x4)
 simple_intropattern(x5) simple_intropattern(x6) simple_intropattern(x7)
 simple_intropattern(x8) ")" constr(pat) := iPoseProofCore lem as pat false
 fun H => iDestructHyp H as ( x1 x2 x3 x4 x5 x6 x7 x8 ) pat.
Time
Tactic Notation
 "iPoseProof" open_constr(lem) "as" "(" simple_intropattern(x1)
...
Tactic Notation "iL\195\182bCore" "as" constr(IH) :=
 (iStartProof; notypeclasses refine (tac_l\195\182b _ IH _ _ _);
   [ reflexivity ||
...
Time
Tactic Notation "iL\195\182bRevert" constr(Hs) "with" tactic(tac) := iRevertIntros
...
Time
Tactic Notation
 "iAssertCore" open_constr(Q) "with" constr(Hs) "as" constr(p) tactic(tac) :=
 (iStartProof;
...
Tactic Notation "iRewriteCore" constr(lr) open_constr(lem) "in" constr(H) :=
 iPoseProofCore lem as true true
 fun Heq =>
...
Time
Tactic Notation "iInvCore" constr(N) "in" tactic(tac) := iInvCore N with
