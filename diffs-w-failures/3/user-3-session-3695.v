...
Time Qed.
Time
Lemma ofe_fun_equivI {A} {B : A \226\134\146 ofeT} (f g : ofe_fun B) :
...
Time Qed.
Time
Lemma ofe_morC_equivI {A B : ofeT} (f g : A -n> B) :
  f \226\137\161 g \226\138\163\226\138\162 (\226\136\128 x, f x \226\137\161 g x).
Time Proof.
Time (apply (anti_symm _)).
Time -
Time (apply (internal_eq_rewrite' f g (\206\187 g, \226\136\128 x : A, f x \226\137\161 g x)%I); auto).
Time -
Time rewrite -(ofe_fun_equivI (ofe_mor_car _ _ f) (ofe_mor_car _ _ g)).
Time
(set
  (h1 :=
   fun f : A -n> B =>
   exist (\206\187 f : A -c> B, NonExpansive (f : A \226\134\146 B)) f (ofe_mor_ne A B f))).
Time
(set
  (h2 :=
   fun f : sigC (\206\187 f : A -c> B, NonExpansive (f : A \226\134\146 B)) =>
