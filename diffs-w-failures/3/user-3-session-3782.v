...
Time Canonical Structure addr_statusC := leibnizC addr_status.
Time Canonical Structure addr_statusF := discreteC addr_status.
...
Time iApply "Hright".
Time }
Time iMod (fupd_big_sepM with "Hdur") as "Hdur".
Time rewrite big_sepM_sep.
