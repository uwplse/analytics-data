...
Definition valid_ancillae {W} (c : Circuit W) : Prop :=
  ...
  \206\147 \226\138\162 c :Circ -> (\226\159\168 \206\1470 | \206\147 \226\138\169 c \226\159\169) \207\129 == (\226\159\168! \206\1470 | \206\147 \226\138\169 c !\226\159\169) \207\129.
...
Fact valid_ancillae_unbox :
  ...
  (forall p, valid_ancillae (c p)) <->
  valid_ancillae_box (box (fun p => c p)).
Proof.
(intros).
...
Lemma update_merge :
  ...
  \206\147' \226\169\181 singleton v W \226\136\153 \206\147 ->
  Valid (update_at \206\147' v (Some W')) \226\169\181 singleton v W' \226\136\153 \206\147.
Proof.
...
Lemma valid_denote_true :
  forall W W' (c : Box W W') (\207\129 : Square (2 ^ \226\159\166 W \226\159\167))
    (\207\129' : Square (2 ^ \226\159\166 W \226\159\167)) (safe : bool),
  Typed_Box c ->
  valid_ancillae_box c ->
  denote_box true c \207\129 == \207\129' -> denote_box safe c \207\129 == \207\129'.
Proof.
...
Lemma valid_denote_false :
  ...
  Typed_Box c ->
  valid_ancillae_box c ->
  denote_box false c \207\129 == \207\129' -> denote_box safe c \207\129 == \207\129'.
Proof.
(intros W W' c \207\129 \207\129' safe T H D).
(destruct safe; trivial).
(unfold valid_ancillae_box in H).
...
Ltac
 case_safe :=
  apply valid_denote_true;
   try (solve
    [ type_check; apply ancilla_free_box_valid; repeat constructor ]).
Ltac
 case_unsafe :=
