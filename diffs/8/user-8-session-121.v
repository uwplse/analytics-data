...
Definition init_discard : Box One One :=
  box_ () \226\135\146 discard $ meas $ init0 $ ().
...
Definition U_deutsch (U__f : Unitary (Qubit \226\138\151 Qubit)) : 
  ...
  box_ () \226\135\146 (let_ x \226\134\144 init0 $ ();
             ...
             let_ x \226\134\144 _H $ x;
             let_ y \226\134\144 meas $ y; let_ () \226\134\144 discard $ y; meas $ x).
...
Lemma lift_deutsch_WT :
  forall U__f, Typed_Box U__f -> Typed_Box (lift_deutsch U__f).
Proof.
type_check.
Qed.
Definition deutsch_basic (U__f : Square_Box (Qubit \226\138\151 Qubit)) : 
  ...
  box_ () \226\135\146 (gate_ x \226\134\144 init0 @ ();
             ...
             gate_ () \226\134\144 discard @ y;
             gate_ x \226\134\144 _H @ x; gate_ x \226\134\144 meas @ x; output x).
Definition deutsch (U__f : Square_Box (Qubit \226\138\151 Qubit)) : 
  ...
  box_ () \226\135\146 (let_ x \226\134\144 _H $ init0 $ ();
             ...
             let_ (x, y)\226\134\144 U__f $ (x, y);
             let_ () \226\134\144 discard $ meas $ y; meas $ _H $ x).
...
Definition Deutsch_Jozsa' (n : nat)
  (U : Box (n \226\168\130 Qubit \226\138\151 Qubit) (n \226\168\130 Qubit \226\138\151 Qubit)) : 
  Box One (n \226\168\130 Bit) :=
  box_ () \226\135\146 (let_ qs \226\134\144 _H # n $ init0 # n $ (());
             let_ q \226\134\144 _H $ init1 $ ();
...
Definition alice : Box (Qubit \226\138\151 Qubit) (Bit \226\138\151 Bit) :=
  box_ qa
  \226\135\146 (let_ (q, a)\226\134\144 CNOT $ qa;
     let_ x \226\134\144 meas $ _H $ q; let_ y \226\134\144 meas $ a; (x, y)).
...
Definition teleport :=
  box_ q
  \226\135\146 (let_ (a, b)\226\134\144 bell00 $ (); let_ (x, y)\226\134\144 alice $ (q, a); bob $ (x, y, b)).
...
Definition teleport_lift : Box Qubit Qubit :=
  ...
  \226\135\146 (let_ (a, b)\226\134\144 bell00 $ ();
     let_ (x, y)\226\134\144 alice $ (q, a); bob_lift $ (x, y, b)).
...
Lemma superdense_distant_WT :
  forall b1 b2, Typed_Box (superdense_distant b1 b2).
Proof.
type_check.
Qed.
Definition _R'_ (m : nat) := _R_ (2 * PI / INR (2 ^ m)).
Fixpoint rotations (n m : nat) {struct n} :
Box (S (S n) \226\168\130 Qubit) (S (S n) \226\168\130 Qubit) :=
  match n with
  | 0 => id_circ
  | S n' =>
      match n' with
...
Fixpoint coin_flips (n : nat) : Box One Bit :=
  box_ () \226\135\146 match n with
            ...
            | S n' =>
                ...
                let_ (c, q)\226\134\144 bit_ctrl _H $ (c, q);
                let_ () \226\134\144 discard $ c; meas $ q
            end.
...
(apply coin_flip_WT).
Qed.
Definition n_coins' (n : nat) : Box One (n \226\168\130 Bit) :=
  box_ () \226\135\146 coin_flip # n $ (()).
Lemma n_coins_WT' : forall n, Typed_Box (n_coins' n).
Proof.
(intros).
...
easy.
Qed.
Definition unitary_transpose {W} (U : Unitary W) : 
  Box W W := box_ p \226\135\146 trans U $ U $ p.
...
Fixpoint prepare_basis (li : list bool) : Box One (length li \226\168\130 Qubit) :=
  ...
  | [] => id_circ
  | b :: bs =>
      box_ () \226\135\146 (let_ p1 \226\134\144 init b $ ();
                 let_ p2 \226\134\144 prepare_basis bs $ (); (p1, p2))
  end.
...
Definition lift_eta : Box Bit Qubit :=
  box_ q \226\135\146 (lift_ x \226\134\144 q; unbox (init x) ()).
