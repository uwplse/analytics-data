Redirect "/tmp/coq3234r_J" Test Search Output Name Only.
Timeout 1 Print Grammar tactic.
Add Search Blacklist "Private_" "_subproof".
Set Printing Depth 50.
Remove Search Blacklist "Private_" "_subproof".
Add Search Blacklist "Private_" "_subproof".
Redirect "/tmp/coq3234UTu" Print Ltac Signatures.
Timeout 1 Print Grammar tactic.
...
Definition network_of_app {nE} `{networkE -< nE} `{exceptE error -< nE} {E} `{E -< nE} (k : shared_key) 
  T (e : (appE id +' exceptE err +' E) T) : itree nE T :=
  match e with
  | (ae|) =>
      match ae with
      | App_Recv =>
...
CoFixpoint match_event {X} (e0 : networkE X) (x0 : X) (t : itree tE unit) : itree tE unit :=
  ...
  | VisF e k =>
      ...
      | (|(ne|)) =>
          ...
          | Network_Send m1, Network_Send m2 => if m1 = m2 ? then id else fun _ _ => throw Error_UnexpectedMessage
...
Definition server : itree sE void := sk <- translate subevent serverHandshake;; interp (network_of_app sk) (nmi_of_smi kvs).
Anomaly ""Assert_failure printing/ppconstr.ml:399:14"." Please report at http://coq.inria.fr/bugs/.
Anomaly ""Assert_failure printing/ppconstr.ml:399:14"." Please report at http://coq.inria.fr/bugs/.
...
Unset Silent.
End Test.
Redirect "/tmp/coq3234hd0" Print Ltac Signatures.
Timeout 1 Print Grammar tactic.
Timeout 1 Print LoadPath.
BackTo 45.
Unset Silent.
...
Unset Silent.
Anomaly ""Assert_failure printing/ppconstr.ml:399:14"." Please report at http://coq.inria.fr/bugs/.
Redirect "/tmp/coq3234TnD" Print Ltac Signatures.
Timeout 1 Print Grammar tactic.
Timeout 1 Check @random.
Timeout 1 Check @random.
Timeout 1 Check @random.
Timeout 1 Check @random.
Timeout 1 Check @embed_exp.
Timeout 1 Check @embed_exp.
Timeout 1 Check @embed_exp.
BackTo 12.
Unset Silent.
