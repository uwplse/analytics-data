Redirect "/var/folders/5x/1mdbpbjd7012l971fq0zkj2w0000gn/T/coq8pJ4vH"
 ...
 ghost_err :=
  iMod (ghost_step_err with "[$] [$] [$]") ||
    ...
    | |- context [ (_ \226\164\135 ?K _)%I ] => iMod
      (@ghost_step_err _ _ _ _ _ _ _ _ _ _ (\206\187 x, K (Bind x _)) with "[$] [$] [$]")
    end; eauto.
Ltac do_then := repeat (do 2 eexists; split; non_err).
Ltac
 err_start := <ssreflect_plugin::ssrtclseq@0> left; right; do_then; destruct (open) ; last  by
 econstructor.
...
(apply nullptr).
Qed.
Lemma open_step_inv {T} j K `{LanguageCtx _ _ T Mail.l K} (\207\131 : l.(OpState)) 
  E :
  nclose sourceN \226\138\134 E
  \226\134\146 j \226\164\135 K (Call Open)
    -\226\136\151 source_ctx -\226\136\151 source_state \207\131 ={E}=\226\136\151 \226\140\156\207\131.(open) = false\226\140\157 \226\136\151 j \226\164\135 K (Call Open) \226\136\151 source_state \207\131.
Proof.
iIntros.
...
Lemma open_open_step_inv {T} {T'} j j' K K' `{LanguageCtx _ _ T Mail.l K}
  `{LanguageCtx _ _ T' Mail.l K'} (\207\131 : l.(OpState)) E :
  nclose sourceN \226\138\134 E
  \226\134\146 j \226\164\135 K (Call Open) -\226\136\151 j' \226\164\135 K' (Call Open) -\226\136\151 source_ctx -\226\136\151 source_state \207\131 ={E}=\226\136\151 False.
Proof.
iIntros ( ? ) "Hj Hj' #Hsrc Hstate".
(<ssreflect_plugin::ssrtclseq@0> iMod (open_step_inv with "[$] [$] [$]") as ( Hopen ) "(?&?)" ; first 
 auto).
...
congruence.
Qed.
Lemma pickup_step_inv {T} j K `{LanguageCtx _ _ T Mail.l K} uid (\207\131 : l.(OpState)) 
  E :
  nclose sourceN \226\138\134 E
  \226\134\146 j \226\164\135 K (pickup uid)
    -\226\136\151 source_ctx
       -\226\136\151 source_state \207\131
          ={E}=\226\136\151 \226\140\156\226\136\131 v, \207\131.(messages) !! uid = Some v\226\140\157 \226\136\151 j \226\164\135 K (pickup uid) \226\136\151 source_state \207\131.
Proof.
iIntros.
(<ssreflect_plugin::ssrtclseq@0> non_err ; last  by solve_err).
(iIntros; iFrame; eauto).
Qed.
Lemma pickup_end_step_inv {T} j K `{LanguageCtx _ _ T Mail.l K} uid (\207\131 : l.(OpState)) 
  msgs E :
  nclose sourceN \226\138\134 E
...
solve_err.
Qed.
Lemma lock_step_inv {T} j K `{LanguageCtx _ _ T Mail.l K} uid (\207\131 : l.(OpState)) 
  E :
  nclose sourceN \226\138\134 E
...
Redirect "/var/folders/5x/1mdbpbjd7012l971fq0zkj2w0000gn/T/coqJ6fLPc" Print Ltac Signatures.
Timeout 1 Print Grammar tactic.
Add Search Blacklist "Raw" "Proofs".
Set Search Output Name Only.
Redirect "/var/folders/5x/1mdbpbjd7012l971fq0zkj2w0000gn/T/coqMo36IU" SearchPattern _.
...
solve_err.
Qed.
Redirect "/var/folders/5x/1mdbpbjd7012l971fq0zkj2w0000gn/T/coq8nCrSZ" Print Ltac Signatures.
Timeout 1 Print Grammar tactic.
Add Search Blacklist "Raw" "Proofs".
Set Search Output Name Only.
Redirect "/var/folders/5x/1mdbpbjd7012l971fq0zkj2w0000gn/T/coqIyNS1t" SearchPattern _.
Remove Search Blacklist "Raw" "Proofs".
Unset Search Output Name Only.
(* Auto-generated comment: Succeeded. *)

(* Auto-generated comment: At 2019-08-14 13:13:46.120000.*)
