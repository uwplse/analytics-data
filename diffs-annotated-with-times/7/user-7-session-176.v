...
(induction w; intros t v HXY; generalize dependent v; induction t; intros v;
  try (solve
   ...
   | split; repeat rewrite subst_union; intros Hm; apply match_ty_union__inv in Hm; destruct Hm as [Hm| Hm];
      [ destruct (IHt1 v) as [Hm1 Hm2] | destruct (IHt2 v) as [Hm1 Hm2] ]; [ apply match_ty_union_1 | apply match_ty_union_2 ]; tauto ])).
(split; repeat rewrite subst_union; intros Hm; apply match_ty_union__inv in Hm; destruct Hm as [Hm| Hm];
  destruct (IHt1 v) as [Hm1 Hm2] || destruct (IHt2 v) as [Hm1 Hm2]; (solve [ (apply match_ty_union_1; auto) || (apply match_ty_union_2; auto) ])).
(* Auto-generated comment: Failed. *)

(* Auto-generated comment: At 2019-08-30 07:19:13.040000.*)
