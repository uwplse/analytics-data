...
Qed.
Lemma match_ty__transitive_on_sub_d : forall t1 t2 : ty, |- t1 << t2 -> forall k : nat, forall v : ty, |-[ k] v <$ t1 -> |-[ k] v <$ t2.
Proof.
(intros t1 t2 Hsub).
(induction Hsub; subst; intros k v Hm1).
-
assumption.
-
auto.
...
(destruct Hm1 as [v1 [v2 [Heq [Hm11 Hm12]]]]; subst).
(apply match_ty_pair; [ apply IHHsub1 | apply IHHsub2 ]; assumption).
-
(apply match_ty_union__inv in Hm1).
(destruct Hm1; [ apply IHHsub1 | apply IHHsub2 ]; assumption).
-
...
(apply match_ty_pair__inv in Hm1).
(destruct Hm1 as [v1 [v2 [Heq [Hm11 Hm12]]]]; subst).
(apply match_ty_union__inv in Hm11).
(destruct Hm11; [ apply match_ty_union_1 | apply match_ty_union_2 ]; apply match_ty_pair; assumption).
-
(apply match_ty_pair__inv in Hm1).
(destruct Hm1 as [v1 [v2 [Heq [Hm11 Hm12]]]]; subst).
(apply match_ty_union__inv in Hm12).
(destruct Hm12; [ apply match_ty_union_1 | apply match_ty_union_2 ]; apply match_ty_pair; assumption).
-
(destruct k).
...
(* Auto-generated comment: At 2019-08-16 13:26:16.480000.*)
