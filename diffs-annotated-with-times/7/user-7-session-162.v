...
Fixpoint subst (x : id) (s t : ty) :=
  ...
  | TExist y t' => let s' := if IdSet.mem y (FV s) then [y @ gen_fresh (FV s)] s else s in TExist y (if beq_id x y then t' else [x := s'] t')
...
(* Auto-generated comment: At 2019-08-29 13:38:30.790000.*)
