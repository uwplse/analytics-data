...
(match goal with
 | |- | ?t1 | <= | ?t2 | =>
       assert (Hv : value_type t1) by constructor; assert (Hm : |-[ 0] t1 <$ t1) by (apply match_ty_i__reflexive; assumption); specialize (H _ Hm);
        ...
        [ apply Nat.le_trans with (| t'1 |) | apply Nat.le_trans with (| t'2 |) ]; try apply Max.le_max_l || apply Max.le_max_r; auto
 end).
(* Auto-generated comment: Failed. *)

(* Auto-generated comment: At 2019-08-12 13:42:30.640000.*)
